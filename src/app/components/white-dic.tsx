...
export default function Whitediv() {
  return (
    <div className="w-full bg-white pt-[100px] pb-[80px] absolute top-[3810px] mt-40">
      <div className="w-full max-w-[1440px] flex flex-col lg:flex-row items-center lg:items-start gap-[30px] px-4 lg:px-0">
        {/* Image Section */}
        <div className="relative w-full lg:w-[707px] h-[400px] lg:h-[682px] flex justify-center ml-5">
          <Image
            src={couples}
            alt="couple"
        ...
        {/* Text Section */}
        <div className="w-full lg:w-[573px] flex flex-col gap-[20px] justify-center items-center lg:items-start text-center lg:text-left mt-[20px] lg:mt-40">
