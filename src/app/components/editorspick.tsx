...
export default function Editors() {
  return (
    <div className="w-full flex justify-center py-[10px] bg-[#f5f5f5]">
      <div className="w-full max-w-[1050px] flex flex-col gap-[30px] bg-[#FAFAFA] p-[40px]">
        {/* Title Section */}
        <div className="flex flex-col items-center gap-[10px]">
          <h3 className="font-Montserrat font-semibold text-[24px] leading-[32px] text-black mt-20">
            EDITOR’S PICK
          </h3>
        ...
        {/* Images Section */}
        <div className="w-full h-auto flex flex-col lg:flex-row gap-[30px]">
          {/* Men Image */}
          ...
          <div className="w-full lg:w-[240px] h-auto flex flex-col gap-[30px]">
            {/* Accessories Image */}
            <div className="relative w-full lg:w-[240px] h-[242px]">
              <Image
                src={div1}
                alt="div1"
                className="w-full h-full object-cover"
